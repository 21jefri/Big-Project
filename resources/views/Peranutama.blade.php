...
<div class="container-fluid">
    ...
    <div class="container">
        <h2 class="fs-3">Apa peran utama anda?</h2>
        <p class="w-50">Ini akan membantu kami untuk menyesuaikan web untuk anda. Kami mungkin juga akan menghubungi anda untuk membantu menemukan fitur yang sesuai dengan bidang pekerjaan anda</p>

      <div>
          <select name="" id="" class="form-select w-25">
              <option value="" disabled selected>Pilih Satu...</option>
              @foreach ($Peran as $peranutama)
              <option value="">{{ $peranutama->peran }}</option>
              @endforeach
           </select>
      </div>
